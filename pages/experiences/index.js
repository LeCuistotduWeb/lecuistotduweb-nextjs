...
const experiencesData = [
  {
    id: 11,
    type: "title",
    title: "2023 à Aujourd'hui",
  },
  {
    id: 10,
    type: "card",
    date: "2023 / Aujourd'hui",
    title: "Développeur Front / Consultant",
    company: "L'Atelier - Société de conseil (Paris)",
    content: "",
  },
  {
    id: 11,
    ...
    content: (
      <>
        <ul>
          ...
          <li>- Aide au développement de nouvelles fonctionnalités sur</li>
        </ul>
      </>
    ),
  },
    ...
    content: (
      <>
        <ul>
          ...
          <li>- Développement de nouvelles fonctionnalités</li>
          <li>- Montage vidéos, retouches photos, créations de visuels</li>
        </ul>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <ul>
          <li>- Amelioration d’UX/UI de site-Web.</li>
          <li>- Correction de bugs d’un site basé sous Wordpress.</li>
          <li>- Covering de vehicule utilitaire.</li>
        </ul>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        <ul>
          <li>- Respect des enjeux de productivité, qualité, hygiène et sécurité.</li>
          <li>- Contrôle, diagnostique et communication des pannes.</li>
          <li>- Proposition d’améliorations du fonctionnement de la ligne.</li>
        </ul>
      </>
    ),
  },
